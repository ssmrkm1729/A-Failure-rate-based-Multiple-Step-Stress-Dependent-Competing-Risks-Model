...
# Optimization (MLE estimation)
result_1 <- optim(par = initial_params, fn = objective_func, method = "L-BFGS-B",
                  lower = lower_bound, upper = upper_bound, hessian = T)
...
# Plot empirical vs theoretical survival
...
margin_1_dataframe = data.frame(
  x1_emp_margin_1,
  y1_emp_margin_1,
  y1_emp_lower_conf_margin_1,
  y1_emp_upper_conf_margin_1,
  y1_theo_margin_1
)
...
margin_2_dataframe = data.frame(
  x1_emp_margin_2,
  y1_emp_margin_2,
  y1_emp_lower_conf_margin_2,
  y1_emp_upper_conf_margin_2,
  y1_theo_margin_2
)
